...
for folds in range(10):
        ...
        #         scoring=scoring,
        #         return_train_score=False)
        # # print( "lr performance: f1:%s auc:%s"%( np.mean(results_lr['test_f1']), np.mean(results_lr['test_roc_auc']) ))
        # store_results("LR", results_lr['test_f1'], results_lr['test_roc_auc'])
        ...
        #         scoring=scoring,
        #         return_train_score=False)
        # # print( "nb performance: f1:%s auc:%s"%( np.mean(results_nb['test_f1']), np.mean(results_nb['test_roc_auc']) ))
        # store_results("NB", results_nb['test_f1'],results_nb['test_roc_auc'])
